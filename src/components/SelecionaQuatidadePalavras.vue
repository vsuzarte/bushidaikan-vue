<template>
  <div class="row q-col-gutter-none justify-center">
    ...
    <div class="col-4 text-center">
      <q-btn text-color="black" class="full-width"  @click="selecionarQuantidade(20)"  dense :color="quantidade === 20 ? 'secondary' : 'amber'"  label="20" />
    </div>
...
export default {
  name: 'SelecionarQuantidadePalavras',
  data() {
    return {
      quantidade: 5,
    }
  ...
  methods: {
    iniciarQuiz() {
      this.$emit('iniciar-quiz', this.quantidade);
    },
